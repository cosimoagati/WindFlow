...
// NB: This implementation returns values from 1 to the maximum
// specified value (both included).  To get a distribution that
// goes from 0 to n - 1, simply subtract 1 to each generated
// element.
...
template<class IntType = unsigned long, class RealType = double>
class shifted_zipf_distribution {
	zipf_distribution<IntType, RealType> dist;
	IntType                              lower;
